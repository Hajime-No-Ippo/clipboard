...
export default function Home() {
  ...
  return (
    <div className="space-y-6">
      <section className="paper pin p-6 pt-8 sm:p-8 sm:pt-10" style={noteStyle(0)}>
        <h1 className="font-serif text-3xl text-[#2f2418] sm:text-4xl">Paste here, read there</h1>
        <p className="mt-3 max-w-xl text-[#5b4632]">
          Pin some text to a board and it shows up instantly on any other device using
      ...
      <section className="paper space-y-5 p-6 pt-7 sm:p-7" style={noteStyle(1)}>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs uppercase tracking-widest text-[#8a6a4a]">or</span>
          <span className="h-px flex-1 bg-[#e3d8c4]" />
        </div>

        <form onSubmit={open} className="space-y-2">
          <label htmlFor="code" className="text-sm font-semibold text-[#2f2418]">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button type="submit" variant="outline" size="icon" aria-label="Open board">
